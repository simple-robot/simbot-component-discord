...
tasks.create("createChangelog") {
    group = "documentation"
    doFirst {
        val realVersion = P.ComponentDiscord.version.toString()
        ...
        if (!file.exists()) {
            ...
            val autoGenerateText = buildString {
                ...
                appendLine(
                    """
                    我们欢迎并期望着您的的[反馈](https://github.com/simple-robot/simbot-component-discord/issues)或[协助](https://github.com/simple-robot/simbot-component-discord/pulls)，
                    感谢您的贡献与支持！
...
tasks.create("updateWebsiteVersionJson") {
    group = "documentation"
    doFirst {
        val version = P.ComponentDiscord.version.toString()
